Parse.Cloud.define('getPhotos', function (request, response) {
  var Image = require("parse-image");
  Parse.Cloud.httpRequest({ url: request.params.url }, {
      error: function (err) {
          response.error(err);
      }
 ...
 */
var githubClientId = 'b0b46d2b5c1e48fab9c5047faae50aec';
var githubClientSecret = 'f3ff10e61864444d9be52b70997442f7';

var githubRedirectEndpoint = 'igb0b46d2b5c1e48fab9c5047faae50aec://authorize';
var githubValidateEndpoint = 'https://api.instagram.com/oauth/access_token';
var githubUserEndpoint = 'https://api.instagram.com/v1/users';
